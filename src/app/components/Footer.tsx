...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F1419] border-t border-[#2A2D3A] mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-bold text-xl">CS2 Derivatives</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Professional derivatives trading platform for CS2 skins with institutional-grade security and real-time market data.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/skins" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Market Overview
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/risk" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Risk Disclosure
                </Link>
              </li>
              <li>
        ...
        {/* Bottom Section */}
        <div className="border-t border-[#2A2D3A] mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} CS2 Derivatives. All rights reserved.
            </div>
